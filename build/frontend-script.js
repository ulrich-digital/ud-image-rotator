...
document.addEventListener("DOMContentLoaded", function () {
  ...
  containers.forEach(container => {
    ...
    if (images.length > 0) {
      ...
      const wrapper = container.querySelector(".ud-image-rotator-block__image-wrapper");
      if (wrapper) {
  ...
  blocks.forEach(block => {
    const image = block.querySelector(".ud-image-rotator-block__image-wrapper img");
    const textWrapper = block.querySelector(".ud-image-rotator-block__text-wrapper");
    const buttonWrapper = block.querySelector(".ud-image-rotator-block__button-wrapper");
    ...
    if (textWrapper) {
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(textWrapper, {
        y: 80,
        opacity: 0
      });
    }
    if (buttonWrapper) {
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(buttonWrapper, {
        x: 150,
        rotation: 90,
        opacity: 0
      });
